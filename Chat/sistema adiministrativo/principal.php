                        ...
                        <h2> Bem Vindo João matador de porco 😱</h2>
                            ...
                            <form action="<?= $destino; ?>" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="codigo" type="text" value="<?php echo isset($usuarios) ? $usuarios['codigo']:''?>" class="form-control" placeholder="Seu codigo">
                                </div>
                                <div class="form-group">
                            ...
                            <tbody>
                                ...
                                while ($coluna = mysqli_fetch_assoc($resultado)) {
                                    ...
                                    <tr>
                                        ...
                                        <td> <a href="<?php echo"./usuario/excluir.php?id=".$coluna['id'];  ?>" >Excluir</a></td>
