                        ...
                        <h2> Bem Vindo João matador de porco 😱</h2>
                            ...
                            <form action="<?= $destino; ?>" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="descricao" type="text" value="<?php echo isset($funcaos) ? $funcaos['descricao']:''?>" class="form-control" placeholder="Seu codigo">
                                </div>
                                <div class="form-group">
                                    <label> Observação </label>
                                    <input name="obs" type="text" value="<?php echo isset($funcaos) ? $funcaos['obs']:''?>" class="form-control" placeholder="Seu nome">
                                </div>
                            ...
                            <tbody>
                                ...
                                while ($coluna = mysqli_fetch_assoc($resultado)) {
                                    ...
                                    <tr>
                                        ...
                                        <td> <a href="<?php echo"./funcao/excluir.php?id=".$coluna['id'];  ?>" >Excluir</a></td>
