...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["mensagem"])) {
        ...
        $sql = "INSERT INTO tabela_mensagens(usuario, mensagem) VALUES
             ('$usuario', '$mensagem')";
    ...
    <div class="painel">
        ...
        <div class="chat">
            ...
            if($resultado-> num_rows > 0){
                ...
                echo"<p> Nenhuma mensagem encontrada!";
            }
        ...
        <form method="POST" action="">
            <input type="text" name="usuario" placeholder="Digite sua mensagem!">
